...
function drawPrimeGlass(rad,n){
 ...
 segment(last,R);
 for(const r of cross){const y=C-rad(r.p);g2.globalAlpha=alpha;g2.strokeStyle='hsl('+hueOf(r.base||r.p)+' 70% 70%)';g2.lineWidth=1.5;g2.beginPath();g2.moveTo(C-6,y);g2.lineTo(C+6,y);g2.stroke();g2.fillStyle=g2.strokeStyle;drawPaneLabel(r.p,rad(r.p),TOP);}
 g2.restore();
}
