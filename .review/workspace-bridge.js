...
updateGuide=function(){redesignedGuide();workspace.update();drawJRadius();const n=Math.floor(t);if(!isPrime(n)&&n>1)$('fac').textContent=factoredName(n);};
