...
export function mountWorkspace(actions:WorkspaceActions){
 ...
 app.append(shell);el('clockSurface').append(clockStage,el('originalProof'));el('clockTransport').append(el('transportCorner'));el('clockWorkspace').insertBefore(el('tapeDomain'),el('clockTransport'));el('clockWorkspace').insertBefore(el('fac'),el('clockTransport'));
